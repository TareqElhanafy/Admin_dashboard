                                    ...
                                    <table
                                        ...
                                        @foreach ($subcategories as $subcategory)
                                         ...
                                         <tr>
                                            ...
                                            <td>{{ $subcategory->trans_lang }} </td>
                                            <td><img style="width: 100px; height:100px;" src="{{asset('storage/' . $subcategory->photo)}}" alt=""></td>
                                                ...
                                                <div class="btn-group" role="group"
                                                    ...
                                                    <a href="{{ route('admin.categories.edit',$subcategory->id) }}"
                                                       ...
                                                       <a href="{{ route('admin.categories.delete',$subcategory->id) }}"
                                                         ...
                                                         <a href="{{ route('admin.categories.changeStatus',$subcategory->id) }}"
